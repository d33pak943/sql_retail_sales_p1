...
-- 2.Write a sql query to retrive all transcations where the category is 'clothing' and the quantity sold is more than 10 in the month of nov-2022
...
select category,count(distinct customer_id) as cnt_unique_customers from retail_sales
group by 1; 
